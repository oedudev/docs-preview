...
![](pathname:///docs-preview/img/introducao-ao-atomic-design-no-hsoares-1.png)
...
![](pathname:///docs-preview/img/introducao-ao-atomic-design-no-hsoares-2.png)

Observe com maior detalhe o formulário, já que a lógica aplicada a ele será a mesma para os outros componentes.

![](pathname:///docs-preview/img/introducao-ao-atomic-design-no-hsoares-3.png)
...
![](pathname:///docs-preview/img/introducao-ao-atomic-design-no-hsoares-4.png)

Molecula:

![](pathname:///docs-preview/img/introducao-ao-atomic-design-no-hsoares-5.png)
...
![](pathname:///docs-preview/img/introducao-ao-atomic-design-no-hsoares-6.png)
...
![](pathname:///docs-preview/img/introducao-ao-atomic-design-no-hsoares-7.png)
...
- **Página:** responsável por buscar e enviar dados (requisições à API).
 ...
 ![](pathname:///docs-preview/img/introducao-ao-atomic-design-no-hsoares-8.png)

- **Template:** recebe dados da página via **props** e os distribui para seus filhos.

![](pathname:///docs-preview/img/introducao-ao-atomic-design-no-hsoares-9.png)

- **Organismos e moléculas:** apenas exibem os dados recebidos ou disparam eventos para a página quando necessário.

![](pathname:///docs-preview/img/introducao-ao-atomic-design-no-hsoares-10.png)

![](pathname:///docs-preview/img/introducao-ao-atomic-design-no-hsoares-11.png)
