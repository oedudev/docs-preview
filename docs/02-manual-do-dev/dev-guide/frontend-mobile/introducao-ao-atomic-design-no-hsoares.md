...
![](/img/introducao-ao-atomic-design-no-hsoares-1.png)
...
![](/img/introducao-ao-atomic-design-no-hsoares-4.png)

Molecula:

![](/img/introducao-ao-atomic-design-no-hsoares-5.png)
...
![](/img/introducao-ao-atomic-design-no-hsoares-6.png)
...
![](/img/introducao-ao-atomic-design-no-hsoares-7.png)
...
- **Página:** responsável por buscar e enviar dados (requisições à API).
 ...
 ![](/img/introducao-ao-atomic-design-no-hsoares-8.png)

- **Template:** recebe dados da página via **props** e os distribui para seus filhos.

![](/img/introducao-ao-atomic-design-no-hsoares-9.png)

- **Organismos e moléculas:** apenas exibem os dados recebidos ou disparam eventos para a página quando necessário.

![](/img/introducao-ao-atomic-design-no-hsoares-10.png)

![](/img/introducao-ao-atomic-design-no-hsoares-11.png)
